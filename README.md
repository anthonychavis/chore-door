...
The goal of this Codecademy project was to build a fully-functional game on a single-page website. The day after completing the project on Codecademy, I challenged myself to build it again without the guidance of the lesson. Of course I played with adding some functionality, styling, and design. At some point, I did have to look into how to tie in some functions to each other.

In the project lesson there was no instruction on how to set up the score keeping despite it being part of the example finished project. So, that was a nice challenge to build completely from scratch.
...
![Example of mobile portrait](./img/mobile-portrait-resize.jpg)
![Example of mobile landscape](./img/mobile-landscape-resize.jpg)
